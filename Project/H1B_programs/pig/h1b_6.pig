--certified
h1b = load '/home/hduser/h1b_final/' using PigStorage() as(sno:int, case_status:chararray, employer_name:chararray, soc_name:chararray, job_title:chararray,full_time_position:chararray,prevailining_wage:double, year:chararray, worksite:chararray, longitude:int, latitude:int);
...
Store data into '/home/hduser/project/output6/certified' using PigStorage();
...
Store data1 into '/home/hduser/project/output6/certified-with' using PigStorage();
...
Store data1 into '/home/hduser/project/output6/withdrawn' using PigStorage();
...
Store data1 into '/home/hduser/project/output6/denied' using PigStorage();
